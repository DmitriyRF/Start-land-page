...
<ul>
	...
	<li><b>Отдельные решения и сайты/сервисы</b>
		<ul>
			...
			<li><a href="https://github.com/mathiasbynens/jquery-placeholder" target="_blank">HTML5 Placeholder jQuery Plugin/</a> — Делает доступным placeholder HTML5 для всез браузеров эффект</li>
